...
class ChannelSubscriptionRenewalEventTest : KickEventDispatcherTest() {
    @Test
    fun shouldDeserializeChannelSubscriptionRenewalEvent() {
        val event = dispatchAndCapture(
            ChannelSubscriptionRenewalEvent::class.java,
